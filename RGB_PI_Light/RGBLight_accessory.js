...
console.log("RGBLight connecting to MQTT broker...");
var options = {
  port: 1883,
  host: '10.0.0.11',
  clientId: 'RGBLight'
...
console.log("RGBLight connected to MQTT broker");
...
var LightController = {
  name: "RGB Light", //name of accessory
  pincode: "031-45-154",
  username: "AA:BC:ED:5A:1A:1A", // MAC like address used by HomeKit to differentiate accessories. 
  ...
  setPower: function(status) { //set power of accessory
    ...
    powerString += status ? "on" : "off";
    client.publish('rgbLight',powerString);
  },
  ...
  setBrightness: function(brightness) { //set brightness
    ...
    var brightString = "brightness ";
    brightString += brightness;
    client.publish('rgbLight',brightString);
  },
  ...
  setSaturation: function(saturation) { //set brightness
    ...
    var satString = "saturation ";
    satString += saturation;
    client.publish('rgbLight',satString);
  },
  ...
  setHue: function(hue) { //set brightness
    ...
    var hueString = "hue ";
    hueString += hue;
    client.publish('rgbLight',hueString);
    this.hue = hue;
  },
